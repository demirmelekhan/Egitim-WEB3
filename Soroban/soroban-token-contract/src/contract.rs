...
#[contractimpl]
impl Token{
    pub fn initialize(e: &Env, admin: Address, dcimal: u32, name: String, symbol: String){
...
impl token::Interface for Token{
    ...
    fn transfer_fro(e: &Env, spender: Address, from: Address, to: Address, amount: i128){
        ...
        spend_balance(&e, from.clone(),spender,amount);
        receive_balance(&e, to.clone(),spender,amount);
        TokenUtils::new(&e).events().transfer(from, to,amount);
    ...
    fn burn(e: &Env, from: Address, amount:i128){
        ...
        e.storage()
            ...
            .extend_ttl(INSTANCE_LIFETIME_THRESHOLD,INSTANCE_BUMP_AMOUNT);
        spend_balance(&e, from.clone(), amount);
        TokenUtils::new(&e).event().burn(from, amount);
    }
